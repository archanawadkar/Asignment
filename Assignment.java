...
public class Assignment {
     ...
     public static void main(String[] args) throws InterruptedException {
		...
		act.sendKeys("Test BC").build().perform();
		...
		WebElement source=driver.findElement(By.xpath("//a[@class=\"list-card js-member-droppable ui-droppable ui-sortable-handle\"]"));
